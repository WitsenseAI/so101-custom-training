...
class LogConfig:
    ...
    '''
    logs_dir: str = WITSENSE_UGV_RL_LOGS_DIR              # Directory for creating logs (if log_dir is not provided)
    ...
    wandb_project: str = "witsense-ugv"                 # Wandb project name
...
class TrainConfig:
    ...
    # Empty, not None: isaaclab's update_class_from_dict infers the expected type from the
    # current value, so a None default rejects a string hydra override.
    load_run: str = ""                  # Load a previously trained model
