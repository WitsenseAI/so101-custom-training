...
def get_project_root() -> Path:
    ...
    # utils -> witsense -> witsense -> source -> lehome_challenge
...
def setup_logger(
    ...
    if name is None:
        ...
        try:
            ...
            name = caller_frame.f_globals.get('__name__', 'witsense')
        finally:
            del frame
...
def set_global_log_file_name(log_file_name: str) -> None:
    ...
    Example:
        ...
        >>> from witsense.utils.logger import set_global_log_file_name
...
def get_logger(name: Optional[str] = None, **kwargs) -> logging.Logger:
    ...
    Example:
        ...
        >>> from witsense.utils.logger import set_global_log_file_name, get_logger
        >>> set_global_log_file_name("custom_name.log")
