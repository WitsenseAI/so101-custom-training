...
from witsense.tasks.bedroom.garment_bi_cfg_v2 import GarmentEnvCfg
from witsense.utils.success_checker_chanllege import (
    check_pant_long,
    check_pant_short,
    check_top_sleeve,
...
from witsense.utils.depth_to_pointcloud import generate_pointcloud_from_data
...
from witsense.assets.object.Garment import GarmentObject
from witsense.tasks.bedroom.challenge_garment_loader import ChallengeGarmentLoader
import logging
