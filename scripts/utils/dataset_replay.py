...
def compute_action_from_ee_pose(
    ...
    """
    import torch
    from witsense.utils import compute_joints_from_ee_pose
    ...
    try:
        ...
        for idx in range(len(episode_data)):
            ...
            if replay_dataset is not None:
                ...
                # task goes as an argument, not a frame key — see dataset_record.py
                replay_dataset.add_frame(frame, frame.pop("task"))
...
def append_episode_initial_pose(
    ...
    """
    from witsense.utils.record import append_episode_initial_pose as append_pose
