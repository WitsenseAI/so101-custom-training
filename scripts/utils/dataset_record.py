...
from witsense.utils.env_utils import dynamic_reset_gripper_effort_limit_sim
from witsense.utils.record import (
...
def create_dataset_if_needed(
    ...
    if getattr(args, "record_ee_pose", False):
        ...
        from witsense.utils import RobotKinematics
    ...
    while episode_index < args.num_episode:
        ...
        while not flags["success"]:
            ...
            if (
                ...
                from witsense.utils import compute_ee_pose_single_arm
            ...
            # lerobot appends the task itself and rejects any frame key that is not a
            # declared feature, so "task" is passed as an argument, not inside the frame.
